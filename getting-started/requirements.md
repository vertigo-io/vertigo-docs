...
* Du Java Development Kit correctement installé - Version : __JDK 17 ou supérieur__
* De  __Maven (version 3.6+ ou supérieure)__ ou __Gradle (version 7.3+ ou supérieure)__  - Maven sera utilisé pour ce guide)
