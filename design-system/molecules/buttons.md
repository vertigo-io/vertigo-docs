...
Nous avons sélectionné trois types de boutons : 
...
- Le libellé doit être le plus court possible et toujours sur une seule ligne
- Mettez en valeur les actions les plus importantes en utilisant la couleur primaire
- Dans une même zone de la page ne mélangez pas différents types de boutons (rond, rectangulaire) et utilisez toujours la même taille
